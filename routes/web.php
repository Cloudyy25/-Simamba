...
Route::middleware('auth')->group(function () {
    ...
    // Dashboard Pimpinan
    Route::get('/pimpinan/dashboard', [DashboardController::class, 'dashboard'])->name('pimpinan.dashboard');
    ...
    Route::get('/pj/dashboard', [DashboardController::class, 'dashboard'])->name('pj.dashboard');
    ...
    // Dashboard Anggota
    Route::get('/anggota/dashboard', [DashboardController::class, 'dashboard'])->name('anggota.dashboard');
