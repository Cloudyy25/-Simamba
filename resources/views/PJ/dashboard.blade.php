...
<body class="flex flex-row h-screen">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            // Cek apakah ada kegiatan yang mendekati batas waktu
            const kegiatanMendekatiBatasWaktu =
                @json($kegiatanMendekatiBatasWaktu); // Mengambil data kegiatan ke dalam JavaScript

            // Tentukan konten HTML berdasarkan apakah ada kegiatan atau tidak
            let htmlContent = '';
            if (kegiatanMendekatiBatasWaktu.length === 0) {
                htmlContent =
                    '<p class="text-center text-lg font-medium text-gray-700">Tidak ada kegiatan yang mendekati batas waktu.</p>';
            } else {
                htmlContent = `
        ...
        `;
            ...
            // Tampilkan SweetAlert dengan konten yang telah disiapkan
            Swal.fire({
