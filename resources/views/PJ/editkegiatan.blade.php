...
<body class="bg-gray-100">
                    ...
                    <form action="{{ route('kegiatan.update', $kegiatan->id_kegiatan) }}" method="POST"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_kegiatan" id="nama_kegiatan"
                                ...
                                class="border p-2 w-full @error('nama_kegiatan') border-red-500 @enderror" required>
                            @error('nama_kegiatan')
                                <div class="text-red-500 text-sm mt-1">Nama Kegiatan Terlalu Panjang</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_tim" id="nama_tim" value="{{ $kegiatan->tim->nama_tim }}"
                                class="border p-2 w-full @error('nama_tim') border-red-500 @enderror" readonly required>
                            @error('nama_tim')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="mulai" id="mulai"
                                value="{{ \Carbon\Carbon::parse($kegiatan->tanggal_mulai)->format('Y-m-d') }}"
                                class="border p-2 w-full @error('mulai') border-red-500 @enderror" required>
                            @error('mulai')
                                <div class="text-red-500 text-sm mt-1"></div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="berakhir" id="berakhir"
                                value="{{ \Carbon\Carbon::parse($kegiatan->tanggal_berakhir)->format('Y-m-d') }}"
                                class="border p-2 w-full @error('berakhir') border-red-500 @enderror" required>
                            @error('berakhir')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="target" id="target" value="{{ $kegiatan->target }}"
                                class="border p-2 w-full @error('target') border-red-500 @enderror" required>
                            @error('target')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="realisasi" id="realisasi"
                                value="{{ $kegiatan->realisasi }}"
                                class="border p-2 w-full @error('realisasi') border-red-500 @enderror" required>
                            @error('realisasi')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="satuan" id="satuan" value="{{ $kegiatan->satuan }}"
                                class="border p-2 w-full @error('satuan') border-red-500 @enderror" required>
                            @error('satuan')
                                <div class="text-red-500 text-sm mt-1"></div>
                            @enderror
                        </div>
                        ...
                        <!-- Tombol Submit -->
                        <button type="submit" class="bg-orange-500 text-white py-2 px-4 rounded">
                            Perbaharui Kegiatan
                        </button>
    ...
    <script>
        ...
        function validateAndSubmit(event) {
            ...
            Swal.fire({
                title: 'Kegiatan berhasil diperbaharui!',
                background: 'linear-gradient(to bottom, #FFC94A, #FFB43A)',
                confirmButtonColor: '#28A745', // Green color for confirm button
                confirmButtonText: 'OK',
                imageUrl: "{{ asset('images/exclamation.png') }}", // Success image
                imageWidth: 100,
                imageHeight: 100,
                imageAlt: 'Success Icon', // Alt text for image
                customClass: {
                    popup: 'w-96 h-60 rounded-lg bg-gradient-to-b from-green-400 to-green-500 p-4 shadow-xl',
                    title: 'text-white text-lg font-semibold',
                    content: 'text-white text-sm',
