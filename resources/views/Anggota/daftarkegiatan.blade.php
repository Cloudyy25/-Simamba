                        ...
                        <table class="w-full table-auto border-collapse mt-4" style="table-layout: fixed;">
                            <thead>
                                <tr class="text-center border-b border-orange-500">
                                    ...
                                    <th class="p-2 text-center border border-orange-500" style="width: 310px;">Kegiatan
                                    </th>
                                    <th class="p-2 text-center border border-orange-500" style="width: 200px;">Tim Kerja
                                    </th>
                                    <th class="p-2 text-center border border-orange-500" style="width: 140px;">Mulai
                                    </th>
                                    <th class="p-2 text-center border border-orange-500" style="width: 140px;">Berakhir
                                    </th>
