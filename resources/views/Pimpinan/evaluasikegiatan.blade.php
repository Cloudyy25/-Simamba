    ...
    <div class="grid lg:grid-cols-[250px_1fr] h-screen">
        ...
        <aside id="sidebar"
            ...
            <nav class="w-full">
                <ul class="text-center space-y-2">
                    ...
                    <a href="{{ route('pimpinan.jadwalkegiatan') }}">
                        <li class="py-2 lg:py-4 cursor-pointer hover:bg-orange-300 transition rounded-lg">Jadwal
                            Kegiatan
                        </li>
                    </a>
        ...
        <div class="flex flex-col bg-white overflow-y-auto">
            ...
            <main class="flex-grow p-6 overflow-y-auto">
                <h2 class="text-4xl font-bold mb-4 flex text-orange-500 justify-between items-center">
                    Evaluasi Kegiatan
